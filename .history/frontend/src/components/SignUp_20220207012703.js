                ...
                <Col lg={5} sm={12} className="p-5 m-auto">
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mt-2">
                            ...
                            <Form.Control type="text" placeholder="Enter password" onChange={} />
                        </Form.Group>

                        <Form.Group className="mt-2">
                            <Form.Label>Description of Organisation</Form.Label>
                            <Form.Control type="text" placeholder="What is the purpose of this organisation" onChange={} />
                        </Form.Group>

                        <Form.Group className="mt-2">
                            <Form.Label>Type of Organisation</Form.Label>
                            <Form.Control type="text" placeholder="Are you an individual, company or non profit" onChange={} />
                        </Form.Group>
